...
public:
    ...
    [[nodiscard]] auto getActionAsChar() const -> char {
        switch (this->action) {
            case MouseAction::Release: return (char) 0;
            case MouseAction::Press: return (char) 1;
            case MouseAction::ScrollUp: return (char) 0x78;
            case MouseAction::ScrollDown: return (char) 0x80;
